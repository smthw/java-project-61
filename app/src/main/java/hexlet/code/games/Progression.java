...
public class Progression {
    ...
    static String[] generateRoundData() {
        ...
        var progressionStep = Utils.randomNumber(PROGRESSION_LENGTH);
        var hiddenElemIndex = Utils.randomNumber(PROGRESSION_LENGTH);
        var progressionFirstElement = Utils.randomNumber(PROGRESSION_START_RANDOM);

        var progression =
                generateProgression(progressionFirstElement, progressionStep, PROGRESSION_LENGTH);
    ...
    static String[] generateProgression(
            int firstElement, int progressionStep, int progressionLength) {
